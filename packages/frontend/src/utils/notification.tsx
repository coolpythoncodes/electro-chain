...
const Notification = ({
  ...
  return toast.custom(
    (t) => (
      <div
        className={`shadow-center bg-base-200 relative flex max-w-sm transform-gpu flex-row items-start justify-between space-x-2 rounded-xl p-4 shadow-accent transition-all duration-500 ease-in-out ${
